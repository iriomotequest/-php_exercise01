...
<body>
    ...
    <form action="" method="post">
        ...
        <select name="item_key">
            <option value=<?=$items[0]?>>バッグ</option>
            <option value=<?=$items[1]?>>靴</option>
            <option value=<?=$items[2]?>>時計</option>
            <option value=<?=$items[3]?>>ネックレス</option>
            <option value=<?=$items[4]?>>ピアス</option>
        </select>
        <br>
        <div class=" submit">
